 ...
 * 总步数（月）
 */
public class PaceMonthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_pace_month, null);
        initView(view);
        return view;
    }
    @Override
    ...
    public int adding(int mi){
        List<SportDataInfo> sportDataInfos = manager.findsportInmonth(mi);
        sum = 0;
