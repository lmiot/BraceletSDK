 ...
 * 热量消耗（月）
 */
public class ConsumptionMonthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_consumption_month, null);
        initView(view);
        return view;
    }
    @Override
    ...
    private void initView(View view) {
        ...
        columnar_chart =(LinearLayout )view.findViewById(R.id.ConsumptionMonthFragment_columnar_chart  ) ;
    ...
    private int adding(int week) {
        List<SportDataInfo> sportDataInfos= manager.findsportInmonth(week);
        sum = 0;
