 ...
 */
public class FiftheenDayfragment extends Fragment {
    private Context context;
    private LinearLayout columnar_chart;
    GraphicalView graphicalView;
    private SimpleDateFormat sdf1,sdf2;
    private Date daynow,day8,day15;
    ...
    private void initialDateformat() {
        ...
        day8=new Date(System.currentTimeMillis()-(24*8*3600*1000));
        day15=new Date(System.currentTimeMillis()-(24*15*3600*1000));
        sdf1=new SimpleDateFormat("yyyy-M-dd");
        sdf2=new SimpleDateFormat("M/dd");
        LogUtils.d("date4",sdf1.format(day8));
        LogUtils.d("date7",sdf1.format(day15));
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.fiftheen_dayfragment, null);
        initView(view);
        return view;
    }
    @Override
    ...
    private void initView(View view) {
        ...
        columnar_chart =(LinearLayout )view.findViewById(R.id.FifteenFragment_columnar_chart ) ;
    ...
    private XYMultipleSeriesDataset getDataset() {
        ...
        String before4daytime=sdf1.format(day8);
        ...
        String before7daytime=sdf1.format(day15);
    ...
    private void setChartSettings(XYMultipleSeriesRenderer renderer) {
       ...
       /* renderer .setShowGridY(true) ;//设置是否需要显示网格
        ...
        //填充X轴的前四天时间
        String Xbefore4dayname=sdf2.format(day8);
        //填充X轴的前七天时间
        String Xbefore7dayname=sdf2.format(day15);
