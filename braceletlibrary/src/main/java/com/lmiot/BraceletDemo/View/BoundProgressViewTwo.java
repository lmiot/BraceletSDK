 ...
 */
public class BoundProgressViewTwo extends View {
    ...
    private static final int[] TEXTS = new int[]
            {R.string .four, R.string .five, R.string .six , R.string .seven  ,
                    R.string .eight, R.string .nine  , R.string .ten , R.string .eleven , R.string .twelve };
            ...
            switch (msg.what) {
                case LINE_ANIM:
                    if (step == 0 && count >= 3 * MAX_COUNT_COEF) {
                        ...
                        return;
                    } else if (step == 7 && count >= 2 * MAX_COUNT_COEF) {
                        return;
                    }
                    else if (step == 8 && count >= 2 * MAX_COUNT_COEF) {
                        return;
                    } else if (step > 8) {
                        return;
                    }
     ...
     * @param attrs
     */
    public BoundProgressViewTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //piece是两个圆之间的宽度
        float piece = (width - 3 * circle_width) / 8f;
        ...
        drawCircle(canvas, paint, piece * 7 + circle_width, cy, circle_width, step >= 7);
        drawCircle(canvas, paint, piece * 8 + circle_width, cy, circle_width, step >= 8);
